      ...
      <Container>
        <Jumbotron className="home-1">
          ...
          <div className="home-icon">
            ...
            <div>
              <p>
                The journey towards achieving your goals is your unique story
                ans we're here to support you.
              </p>
            </div>
          </div>
          ...
          <div className="home-icon">
            ...
            <div>
              <p>
                Celebrate accomplishments with badges, rewards ans save your
                story in the library for others to see!
              </p>
            </div>
          </div>
        </Jumbotron>
